...
function download_album {
	...
	BASE_URL="p23-sharedstreams.icloud.com"
	BASE_API_URL="https://${BASE_URL}/${ALBUM}/sharedstreams"
...
while read line; do
	...
	download_album "$ALBUM_URL" "$DESTINATION"
